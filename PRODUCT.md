...
- Generic SaaS templates or startup-bubbly aesthetics
- Cold corporate or sterile agency portfolios
...
- **Confidence through restraint** — every element must earn its place. Empty space is not wasted space; it frames what matters.
...
- WCAG AA minimum across all surfaces (4.5:1 body contrast, keyboard operable, screen reader friendly)
- Reduced motion support via `prefers-reduced-motion` for every animation
